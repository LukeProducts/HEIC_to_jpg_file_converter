...
def startsymbol():
    ...
    print("""
 /$$   /$$ /$$$$$$$$ /$$$$$$  /$$$$$$        /$$$$$$$$ /$$$$$$           /$$$$$ /$$$$$$$   /$$$$$$ 
| $$  | $$| $$_____/|_  $$_/ /$$__  $$      |__  $$__//$$__  $$         |__  $$| $$__  $$ /$$__  $$
| $$  | $$| $$        | $$  | $$  \__/         | $$  | $$  \ $$            | $$| $$  \ $$| $$  \__/
| $$$$$$$$| $$$$$     | $$  | $$               | $$  | $$  | $$            | $$| $$$$$$$/| $$ /$$$$
| $$__  $$| $$__/     | $$  | $$               | $$  | $$  | $$       /$$  | $$| $$____/ | $$|_  $$
| $$  | $$| $$        | $$  | $$    $$         | $$  | $$  | $$      | $$  | $$| $$      | $$  \ $$
| $$  | $$| $$$$$$$$ /$$$$$$|  $$$$$$/         | $$  |  $$$$$$/      |  $$$$$$/| $$      |  $$$$$$/
|__/  |__/|________/|______/ \______/          |__/   \______/        \______/ |__/       \______/ 
...
while Program:
    X = input("Soll das Konvertieren in .jpg gestartet werden?\nJA[ENTER] oder Nein[N]")
    os.system('color A')
    if X == '':
        search()
    if X == 'N':
